...
HD_PWD='C:/Users/Hugo/Documents/GitHub/WAV_Player/05_FPGA/Arty-S7/WAV_Player/WAV_Player.runs/CHN_Config_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CHN_Config_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CHN_Config_RAM.tcl
