...
HD_PWD='C:/Users/Hugo/Documents/GitHub/WAV_Player/05_FPGA/Arty-S7/WAV_Player/WAV_Player.runs/Audio_Interface_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Audio_Interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Audio_Interface.tcl
