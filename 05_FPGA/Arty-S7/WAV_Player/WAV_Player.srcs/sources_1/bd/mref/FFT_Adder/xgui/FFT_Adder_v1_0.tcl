...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "G_SUB_EN" -parent ${Page_0}
...
proc update_PARAM_VALUE.G_SUB_EN { PARAM_VALUE.G_SUB_EN } {
	# Procedure called to update G_SUB_EN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.G_SUB_EN { PARAM_VALUE.G_SUB_EN } {
	# Procedure called to validate G_SUB_EN
	return true
}
...
proc update_MODELPARAM_VALUE.G_SUB_EN { MODELPARAM_VALUE.G_SUB_EN PARAM_VALUE.G_SUB_EN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.G_SUB_EN}] ${MODELPARAM_VALUE.G_SUB_EN}
}
