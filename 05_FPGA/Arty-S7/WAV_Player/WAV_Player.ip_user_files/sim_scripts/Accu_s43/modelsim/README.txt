...
#
# Generated by export_simulation on Tue Aug 25 11:27:50 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './Accu_s43.sh' script.

./Accu_s43.sh -reset_run
...
./Accu_s43.sh -noclean_files

For more information on the script, please type './Accu_s43.sh -help'.
