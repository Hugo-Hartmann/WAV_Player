...
#
# Generated by export_simulation on Mon Aug 24 18:40:51 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './Accu_s41.sh' script.

./Accu_s41.sh -reset_run
...
./Accu_s41.sh -noclean_files

For more information on the script, please type './Accu_s41.sh -help'.
