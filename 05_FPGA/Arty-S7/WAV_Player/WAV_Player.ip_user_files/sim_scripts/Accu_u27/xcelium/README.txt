...
#
# Generated by export_simulation on Sat Dec 21 12:41:39 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './Accu_u27.sh' script.

./Accu_u27.sh -reset_run
...
./Accu_u27.sh -noclean_files

For more information on the script, please type './Accu_u27.sh -help'.
