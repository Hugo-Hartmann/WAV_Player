...
#
# Generated by export_simulation on Tue Nov 26 16:54:35 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './EQ.sh' script.
...
For more information on the script, please type './EQ.sh -help'.
