...
#
# Generated by Vivado on Tue Nov 26 16:54:48 +0100 2019
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FIR xil_defaultlib.FIR xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FIR -key {Behavioral:sim_1:Functional:FIR} -tclbatch cmd.tcl -protoinst "protoinst_files/EQ.protoinst" -protoinst "protoinst_files/FIR.protoinst" -protoinst "protoinst_files/FFT_512.protoinst" -log simulate.log
}
