...
#
# Generated by export_simulation on Thu Dec 19 11:36:12 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './FIFO_32bit.sh' script.

./FIFO_32bit.sh -reset_run
...
./FIFO_32bit.sh -noclean_files

For more information on the script, please type './FIFO_32bit.sh -help'.
