...
#
# Generated by export_simulation on Tue Dec 31 12:31:50 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './Accu_u20.sh' script.

./Accu_u20.sh -reset_run
...
./Accu_u20.sh -noclean_files

For more information on the script, please type './Accu_u20.sh -help'.
