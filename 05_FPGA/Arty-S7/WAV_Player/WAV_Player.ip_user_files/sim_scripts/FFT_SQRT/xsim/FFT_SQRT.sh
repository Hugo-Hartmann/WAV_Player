...
#
# Generated by Vivado on Tue Nov 26 11:40:20 +0100 2019
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: FFT_SQRT.sh [-help]
# usage: FFT_SQRT.sh [-lib_map_path]
# usage: FFT_SQRT.sh [-noclean_files]
# usage: FFT_SQRT.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "FFT_SQRT.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./FFT_SQRT.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FFT_SQRT.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./FFT_SQRT.sh -help\" for more information)\n"
    exit 1
  fi
